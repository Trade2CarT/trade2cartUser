            ...
            <footer className="flex justify-end mt-10">
                <div className="w-1/3">
                    <div className="flex justify-between items-center py-2">
                        ...
                        <span className="text-sm font-medium">₹{(parseFloat(trade.totalAmount) || 0).toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-t-2 border-gray-800">
                        <span className="text-lg font-bold">Grand Total</span>
                        <span className="text-lg font-bold">₹{(parseFloat(trade.totalAmount) || 0).toFixed(2)}</span>
                    </div>
                </div>
            </footer>
