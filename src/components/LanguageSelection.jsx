            ...
            {[
              ...
              return (
                <button
                  ...
                  className={`w-full bg-white text-center px-4 py-3 rounded-xl shadow-md text-lg text-gray-700 font-medium
                    ${isDisabled
                      ? 'opacity-50 cursor-not-allowed'
                      : 'hover:bg-gray-100 hover:scale-105 transform transition-all duration-200 cursor-pointer'
                    }
                  `}
                >
                  {label}
