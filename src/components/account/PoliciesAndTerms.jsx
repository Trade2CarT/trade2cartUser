    ...
    const privacyContent = `
        <div class="prose max-w-none text-gray-700">
            ...
            <ul class="list-disc list-inside space-y-1">
                ...
                <li>You can request access to your data or ask for deletion by emailing <a href="mailto:trade@trade2cart.in" class="text-brand-600 hover:underline">trade@trade2cart.in</a>.</li>
            </ul>
    ...
    const termsContent = `
        <div class="prose max-w-none text-gray-700">
            ...
            <ul class="list-disc list-inside space-y-1">
                ...
                <li>Contact us at <a href="mailto:trade@trade2cart.in" class="text-brand-600 hover:underline">trade@trade2cart.in</a> or visit our website <a href="https://trade2cart.in" target="_blank" rel="noopener noreferrer" class="text-brand-600 hover:underline">trade2cart.in</a>.</li>
            </ul>
        </div>
    `;
